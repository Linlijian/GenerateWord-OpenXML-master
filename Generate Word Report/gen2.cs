...
namespace Generate_Word_Report
{
    public class gen2
    {
        ...
        private void CreateParts(WordprocessingDocument document)
        {
            ...
            FN_LineChart(chartPart1, Series, Category, Values);
            ...
            //--
            //ChartPart chartPart3 = mainDocumentPart1.AddNewPart<ChartPart>("rId99");
            //FN_BarChart(chartPart3, data, "");

            //EmbeddedPackagePart embeddedPackagePart3 = chartPart1.AddNewPart<EmbeddedPackagePart>("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "rId1");
