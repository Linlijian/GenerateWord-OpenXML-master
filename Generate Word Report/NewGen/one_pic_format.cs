   ...
   public class one_pic_format
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Wp.LineTo lineTo1 = new Wp.LineTo() { X = 0L, Y = 21564L };
            Wp.LineTo lineTo2 = new Wp.LineTo() { X = 21563L, Y = 21564L };
            Wp.LineTo lineTo3 = new Wp.LineTo() { X = 21563L, Y = 0L };
