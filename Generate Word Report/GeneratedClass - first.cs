...
namespace Generate_Word_Report
{
    public class GeneratedClassbk
    {
        ...
        public void CreatePackage(string filePath)
        {
            ...
            {
                //FN_CreateParts(package);    
                CreateParts(package);
                //O_CreateParts(package);
            }
        }

        private void FN_CreateParts(WordprocessingDocument document)
        {
            #region doc setting id = rId3
            ...
            //build vlues
            string[] Series = { "Series 1", "Series 2", "Series 3", "Series 4" };
            string[] Category = { "Category 1", "Category 2", "Category 3", "Category 4" };
            string[,] Values = new string[,]
            {
                {"70", "20", "0", "14" }, //Series 1
                {"10", "20", "30", "40" }, //Series 2
                {"11", "22", "33", "44" }, //Series 3
                {"20", "40", "60", "80" }  //Series 4
            };
            ...
            #region add chart id = rId13
            ChartPart chartPart1 = mainDocumentPart1.AddNewPart<ChartPart>("rId7");
            FN2_PieChart(chartPart1, Series, Values);
            ...
            ChartPart chartPart2 = mainDocumentPart1.AddNewPart<ChartPart>("rId13");
            FN_LineChart(chartPart2, Series, Category, Values);
        ...
        private void    CreateParts(WordprocessingDocument document)
        {
            ...
            //PieChart(chartPart2);
            //FN_PieChart(chartPart2);
            //FN2_PieChart(chartPart2, Series, Values);
            //FN_`Chart(chartPart2, Series, Category, Values);
            //GenerateChartPart(chartPart2, data, "");
        ...
        private void O2_CreateParts(WordprocessingDocument document)
        {
        ...
        private void O_CreateParts(WordprocessingDocument document)
        {
            ExtendedFilePropertiesPart extendedFilePropertiesPart1 = document.AddNewPart<ExtendedFilePropertiesPart>("rId3");
            GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);
        ...
        private void GenerateChartPart2Content(ChartPart chartPart2)
        {
            ...
            for (int i = 0; i <= 3; i++)
            {
                ...
                numericValue33.Text = (10 + i).ToString(); // <== this
        ...
        private void PieChart(ChartPart chartPart2)
        {
            #region prop chart
            //========start hearder xml
            C.ChartSpace chartSpace2 = new C.ChartSpace();
            ...
            C.PlotArea plotArea2 = new C.PlotArea();
            C.Layout layout2 = new C.Layout();
            //========end chart hearder xml
           
            //========start chart and prop type xml
            C.PieChart pieChart1 = new C.PieChart();
            C.VaryColors varyColors2 = new C.VaryColors() { Val = true };

            C.PieChartSeries pieChartSeries1 = new C.PieChartSeries();
            C.Index index4 = new C.Index() { Val = (UInt32Value)0U }; //0
            C.Order order4 = new C.Order() { Val = (UInt32Value)0U }; //0
            //========end chart and prop type xml
        ...
        private void FN_PieChart(ChartPart chartPart2, string[] Series, string[,] Values)
        {
            C.ChartSpace chartSpace2 = new C.ChartSpace();
            chartSpace2.AddNamespaceDeclaration("c", "http://schemas.openxmlformats.org/drawingml/2006/chart");
            chartSpace2.AddNamespaceDeclaration("a", "http://schemas.openxmlformats.org/drawingml/2006/main");
            ...
            stringReference7.Append(formula);
            stringReference7.Append(stringCache7);
            ...
            formula.Text = "Sheet1!$A$2:$A$5";

            C.StringCache stringCache = new C.StringCache();
            C.PointCount pointCount = new C.PointCount() { Val = UInt32Value.FromUInt32((UInt32)(Series.Length)) };
            ...
            for (int i = 0; i < Series.Length; i++)
            {
                ...
                C.StringPoint stringPoint = new C.StringPoint() { Index = UInt32Value.FromUInt32((UInt32)(i)) };
                C.NumericValue numericValue = new C.NumericValue();
                numericValue.Text = Series[i];
            ...
            pieChartSeries1.Append(order4);
            pieChartSeries1.Append(seriesText4);
            pieChartSeries1.Append(categoryAxisData);
            pieChartSeries1.Append(values);
        ...
        private void FN2_PieChart(ChartPart chartPart2, string[] Series, string[,] Values)
        {
            C.ChartSpace chartSpace2 = new C.ChartSpace();
            C.Date1904 date19042 = new C.Date1904() { Val = false };
            C.EditingLanguage editingLanguage2 = new C.EditingLanguage() { Val = "en-US" };
            ...
            AlternateContentChoice alternateContentChoice2 = new AlternateContentChoice() { Requires = "c14" };
            alternateContentChoice2.AddNamespaceDeclaration("c14", "http://thailend");
            C14.Style style3 = new C14.Style() { Val = 102 };
        ...
        private void FN_PieChart(ChartPart chartPart2)
        {
            #region prop chart
            //========start hearder xml
            C.ChartSpace chartSpace = new C.ChartSpace();
            C.Date1904 date1904 = new C.Date1904() { Val = false };
            C.EditingLanguage editingLanguage = new C.EditingLanguage() { Val = "en-US" };
            ...
            alternateContentChoice.AddNamespaceDeclaration("c14", "http://thailend");
            C14.Style Choice_style = new C14.Style() { Val = 102 };

            alternateContentChoice.Append(Choice_style);

            AlternateContentFallback alternateContentFallback = new AlternateContentFallback();
            C.Style Fallback_style = new C.Style() { Val = 2 };

            alternateContentFallback.Append(Fallback_style);
            ...
            C.VaryColors varyColors = new C.VaryColors() { Val = true };

            C.PieChartSeries pieChartSeries = new C.PieChartSeries();
            C.Index index = new C.Index() { Val = (UInt32Value)0U }; //0
            C.Order order = new C.Order() { Val = (UInt32Value)0U }; //0
            //========end chart and prop type xml
            ...
            formula = new C.Formula();
            formula.Text = "Sheet1!$A$2:$A$5";
            string[] Series = { "1st Qtr", "2nd Qtr", "3rd Qtr", "4th Qtr" };
            string[] Values = { "114", "70", "99", "59" };
            for (int i = 0; i < Series.Length; i++)
            {
                if(i == 0)
                {
                    //กำหนด Series ทั้งหมดว่าจะเอาเท่าไหร่
                ...
                stringPoint = new C.StringPoint() { Index = UInt32Value.FromUInt32((UInt32)(i)) };
            ...
            {
                C.NumericPoint numericPoint = new C.NumericPoint() { Index = UInt32Value.FromUInt32((UInt32)i) };
                numericValue = new C.NumericValue();
                numericValue.Text = Values[i];
                numericPoint.Append(numericValue);
                numberingCache.Append(numericPoint);
            }
            ...
            C.ShowLeaderLines showLeaderLines = new C.ShowLeaderLines() { Val = true };
            ...
            pieChart.Append(varyColors);
            pieChart.Append(pieChartSeries);
            pieChart.Append(dataLabels);
            pieChart.Append(firstSliceAngle);
            ...
            chartPart2.ChartSpace = chartSpace;
            //======== end add data xml
            #endregion

        }

        private void LineChart(ChartPart chartPart2)
        {
            #region chart prop
            //===========start header xml
            C.ChartSpace chartSpace1 = new C.ChartSpace();
            ...
            AlternateContentChoice alternateContentChoice1 = new AlternateContentChoice() { Requires = "c14" };
            alternateContentChoice1.AddNamespaceDeclaration("c14", "null");
            ...
            C.Grouping grouping1 = new C.Grouping() { Val = C.GroupingValues.Standard };
            C.VaryColors varyColors1 = new C.VaryColors() { Val = false };
            //===========end chart prop type xml
            #endregion
           
            #region values data
            //===========start chart add data 1 - series xml
            C.LineChartSeries lineChartSeries1 = new C.LineChartSeries();
            C.Index index1 = new C.Index() { Val = (UInt32Value)0U };
            C.Order order1 = new C.Order() { Val = (UInt32Value)0U };
            ...
            marker1.Append(symbol1);
            //===========end  chart add data 1 - series xml

            //===========start chart add data 1 - category xml
            C.CategoryAxisData categoryAxisData1 = new C.CategoryAxisData();
            ...
            categoryAxisData1.Append(stringReference2);
            //===========end chart add data 1 - category xml
            ...
            lineChartSeries1.Append(values1);
            lineChartSeries1.Append(smooth1);
            //===========end chart add data 1 - values xml

            //===========start chart add data 2 - series xml
            C.LineChartSeries lineChartSeries2 = new C.LineChartSeries();
            C.Index index2 = new C.Index() { Val = (UInt32Value)1U };
            C.Order order2 = new C.Order() { Val = (UInt32Value)1U };
            ...
            marker2.Append(symbol2);
            //===========end chart add data 2 - series xml

            //===========start chart add data 2 - category xml
            C.CategoryAxisData categoryAxisData2 = new C.CategoryAxisData();
            ...
            categoryAxisData2.Append(stringReference4);
            //===========end chart add data 2 - category xml

            //===========start chart add data 2 - values xml
            C.Values values2 = new C.Values();
            ...
            lineChartSeries2.Append(values2);
            lineChartSeries2.Append(smooth2);
            //===========end chart add data 2- values xml

            //===========start chart add data 3 - series xml
            C.LineChartSeries lineChartSeries3 = new C.LineChartSeries();
            C.Index index3 = new C.Index() { Val = (UInt32Value)2U };
            C.Order order3 = new C.Order() { Val = (UInt32Value)2U };
            ...
            marker3.Append(symbol3);
            //===========end chart add data 3 - series xml

            //===========start chart add data 3 - category xml
            C.CategoryAxisData categoryAxisData3 = new C.CategoryAxisData();
            ...
            categoryAxisData3.Append(stringReference6);
            //===========end chart add data 3 - category xml

            //===========start chart add data 3 - values xml
            C.Values values3 = new C.Values();
            ...
            lineChartSeries3.Append(values3);
            lineChartSeries3.Append(smooth3);
            //===========end chart add data 3 - values xml
            #endregion
            ...
            //===========start add all values to chart xml
            lineChart1.Append(grouping1);
            lineChart1.Append(varyColors1);
            lineChart1.Append(lineChartSeries1);
            lineChart1.Append(lineChartSeries2);
            ...
            lineChart1.Append(axisId1);
            lineChart1.Append(axisId2);
            //===========end add all values to chart xml
            ...
            chartPart2.ChartSpace = chartSpace1;
            #endregion
        }

        private void LineChartลองลูป(ChartPart chartPart2)
        {

            //pointCount = new C.PointCount() { Val = UInt32Value.FromUInt32((UInt32)(i)) };
            #region chart prop
            //===========start header xml
            C.ChartSpace chartSpace = new C.ChartSpace();
            C.Date1904 date1904 = new C.Date1904() { Val = false };
            ...
            AlternateContentChoice alternateContentChoice = new AlternateContentChoice() { Requires = "c14" };
            alternateContentChoice.AddNamespaceDeclaration("c14", "null");

            C14.Style style = new C14.Style() { Val = 102 };
            ...
            alternateContentFallback.Append(style2);
            ...
            //===========start chart prop type xml
            C.Chart chart = new C.Chart();
            C.AutoTitleDeleted autoTitleDeleted = new C.AutoTitleDeleted() { Val = true };
            ...
            string[] Category = { "Category 1", "Category 2", "Category 3", "Category 4" };
            string[] Values = { "77", "2", "73", "14" };
            string[] Sheet = { "A", "B", "C", "D", "E" };
            for (int i = 1; i <= Series.Length; i++)
            {
                C.LineChartSeries lineChartSeries = new C.LineChartSeries();
                C.Index index = new C.Index() { Val = UInt32Value.FromUInt32((UInt32)(i - 1)) };
                C.Order order = new C.Order() { Val = UInt32Value.FromUInt32((UInt32)(i - 1)) };

                C.SeriesText seriesText = new C.SeriesText();

                C.StringReference stringReference = new C.StringReference();
                C.Formula formula = new C.Formula();
                formula.Text = string.Format("Sheet1!${0}$1", Sheet[i]); //start B

                C.StringCache stringCache = new C.StringCache();
                C.PointCount pointCount = new C.PointCount() { Val = UInt32Value.FromUInt32((UInt32)(1)) };

                C.StringPoint stringPoint = new C.StringPoint() { Index = UInt32Value.FromUInt32((UInt32)(0)) };
                C.NumericValue numericValue = new C.NumericValue();
                numericValue.Text = Series[i - 1];
                ...
                //create category
                C.StringPoint stringPointCategory;
                C.NumericValue numericValueCategory;
                C.CategoryAxisData categoryAxisData = new C.CategoryAxisData();
                for (int j = 0; j < Category.Length; j++)
                {
                    if(j == 0)
                    {
                        stringReference = new C.StringReference();
                        formula = new C.Formula();
                        formula.Text = string.Format("Sheet1!${0}${1}:${2}${3}", Sheet[j], 1, Sheet[j], Sheet.Length);

                        stringCache = new C.StringCache();
                        pointCount = new C.PointCount() { Val = UInt32Value.FromUInt32((UInt32)(Category.Length)) };
                        stringCache.Append(pointCount);
                    }
                    

                    stringPointCategory = new C.StringPoint() { Index = UInt32Value.FromUInt32((UInt32)(j)) };
                    numericValueCategory = new C.NumericValue();
                    numericValueCategory.Text = Category[j];

                    stringPointCategory.Append(numericValueCategory);
                    stringCache.Append(stringPointCategory);
                }
                ...
                //add values
                C.NumericValue numericValues;
                C.NumericPoint numericPoint;
                C.NumberingCache numberingCache = new C.NumberingCache();
                C.NumberReference numberReference = new C.NumberReference();
                C.Values values = new C.Values();
                C.FormatCode formatCode = new C.FormatCode();
                for (int z = 0; z < Values.Length; z++)
                {
                    ...
                    {
                        formula = new C.Formula();
                        formula.Text = string.Format("Sheet1!$B$2:$B$5", Sheet[z + 1], z + 1, Sheet[z + 1], Values.Length + 1);
                        
                        formatCode.Text = "General";
                        pointCount = new C.PointCount() { Val = UInt32Value.FromUInt32((UInt32)(Values.Length)) };

                        numberingCache.Append(formatCode);
                        numberingCache.Append(pointCount);
                    }

                    numericPoint = new C.NumericPoint() { Index = UInt32Value.FromUInt32((UInt32)(z)) };
                    numericValues = new C.NumericValue();
                    numericValues.Text = Values[z];

                    numericPoint.Append(numericValues);
                    numberingCache.Append(numericPoint);
                }
                numberReference.Append(formula);
                numberReference.Append(numberingCache);
            ...
            dataLabels.Append(showPercent);
            dataLabels.Append(showBubbleSize);
            C.ShowMarker showMarker = new C.ShowMarker() { Val = true };
            C.Smooth smooth4 = new C.Smooth() { Val = false };
            C.AxisId axisId1 = new C.AxisId() { Val = (UInt32Value)231952384U };
            C.AxisId axisId2 = new C.AxisId() { Val = (UInt32Value)231953920U };
            ...
            C.MajorTickMark majorTickMark = new C.MajorTickMark() { Val = C.TickMarkValues.Outside };
            ...
            C.CrossingAxis crossingAxis = new C.CrossingAxis() { Val = (UInt32Value)231953920U };
            ...
            axisId = new C.AxisId() { Val = (UInt32Value)231953920U };

            scaling = new C.Scaling();
            orientation = new C.Orientation() { Val = C.OrientationValues.MinMax };

            scaling.Append(orientation);
            delete = new C.Delete() { Val = false };
            axisPosition = new C.AxisPosition() { Val = C.AxisPositionValues.Left };
            C.MajorGridlines majorGridlines = new C.MajorGridlines();
            C.NumberingFormat numberingFormat = new C.NumberingFormat() { FormatCode = "General", SourceLinked = true };
            majorTickMark = new C.MajorTickMark() { Val = C.TickMarkValues.Outside };
            minorTickMark = new C.MinorTickMark() { Val = C.TickMarkValues.None };
            tickLabelPosition = new C.TickLabelPosition() { Val = C.TickLabelPositionValues.NextTo };
            crossingAxis = new C.CrossingAxis() { Val = (UInt32Value)231952384U };
            crosses = new C.Crosses() { Val = C.CrossesValues.AutoZero };
            C.CrossBetween crossBetween = new C.CrossBetween() { Val = C.CrossBetweenValues.Between };
            ...
            chart.Append(displayBlanksAs1);
            chart.Append(showDataLabelsOverMaximum1);
        ...
        private void FN_LineChart(ChartPart chartPart2, string[] Series, string[] Category, string[,] Values)
        {
            ...
            for (int i = 1; i <= Series.Length; i++)
            {
                ...
                for (int j = 0; j < Category.Length; j++)
                {
                    if (j == 0)
                    {
                        stringReference = new C.StringReference();
                        formula = new C.Formula();
                        formula.Text = string.Format("Sheet1!${0}${1}:${2}${3}", Sheet[j], 1, Sheet[j], Values.Length + 1); //Sheet.Length
                ...
                ///Category = values
                ///ถ้าไม่เท่ากันข้อมมูลจะออกตาม Category ที่มี เช่น 
                ///Category = 3 ส่ง values มา 5 กราฟจะแสดงแค่ 3 values
                ///จึงใช้ Category ในการวน
                ...
                {                    
                    ...
                    formula = new C.Formula();
                    formula.Text = string.Format("Sheet1!${0}${1}:${2}${3}", Sheet[z + 1], 1, Sheet[z + 1], Category.Length + 1);
                    numericPoint = new C.NumericPoint() { Index = UInt32Value.FromUInt32((UInt32)(z)) };
                    numericValues = new C.NumericValue();
                    numericValues.Text = Values[i - 1, z];
        ...
        private void GenerateChartPart(ChartPart chartPart2, Dictionary<string, int> data, string chartTitle, int chartTitleSize = 12, int axisLabelSize = 10)
        {
