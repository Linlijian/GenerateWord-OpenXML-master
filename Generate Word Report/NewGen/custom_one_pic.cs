...
namespace Generate_Word_Report.NewGen
{
    public class custom_one_pic
    {
        ...
        private Drawing addPicFormat(string rId, int horizontalPosition, int verticalPosition, int sizeX, int sizeY)
        {
            ...
            Wp.HorizontalPosition horizontalPosition1 = new Wp.HorizontalPosition() { RelativeFrom = Wp.HorizontalRelativePositionValues.Margin };
            Wp.PositionOffset positionOffset1 = new Wp.PositionOffset();
            positionOffset1.Text = horizontalPosition.ToString();

            horizontalPosition1.Append(positionOffset1);

            Wp.VerticalPosition verticalPosition1 = new Wp.VerticalPosition() { RelativeFrom = Wp.VerticalRelativePositionValues.Paragraph };
            Wp.PositionOffset positionOffset2 = new Wp.PositionOffset();
            positionOffset2.Text = verticalPosition.ToString();
        ...
        private Paragraph newLineImage(string paragraphId, string textId, string rId, int horizontalPosition, int verticalPosition, int sizeX, int sizeY)
        {
            Paragraph paragraph = newLine(paragraphId, textId);
            Run run = new Run();
            ...
            Drawing drawing = addPicFormat(rId, horizontalPosition, verticalPosition, sizeX, sizeY);
        ...
        private System.Collections.Generic.List<long> Getlong(string base64image, int sizeX, int sizeY)
        {
