...
namespace Generate_Word_Report
{
    public class Yona
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = GenerateParagraph();
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            Rsid rsid3 = new Rsid() { Val = "009E771B" };
            Rsid rsid4 = new Rsid() { Val = "00C035C0" };
            Rsid rsid5 = new Rsid() { Val = "00F30FE0" };
        ...
        {
            document.PackageProperties.Creator = "pornchai klinmala";
            document.PackageProperties.Title = "";
            document.PackageProperties.Subject = "";
            document.PackageProperties.Keywords = "";
            document.PackageProperties.Description = "";
            document.PackageProperties.Revision = "5";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2021-10-04T03:06:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2021-10-04T03:07:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "pornchai klinmala";
        }

        public Paragraph GenerateParagraph()
        {
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "004670D4", RsidParagraphProperties = "009E771B", RsidRunAdditionDefault = "00C035C0", ParagraphId = "5452AA23", TextId = "7EE767EA" };
