...
namespace Generate_Word_Report.NewGen
{
    public class text__list
    {
        ...
        private void GenerateNumberingDefinitionsPart1Content(NumberingDefinitionsPart numberingDefinitionsPart1)
        {
            ...
            TemplateCode templateCode1 = new TemplateCode() { Val = "8DE618DA" };

            Level level1 = new Level() { LevelIndex = 0, TemplateCode = "2340CDE0" };
            ...
            RunFonts runFonts2 = new RunFonts() { Hint = FontTypeHintValues.Default, Ascii = "Calibri", HighAnsi = "Calibri", ComplexScript = "Calibri", EastAsiaTheme = ThemeFontValues.MinorEastAsia };
            ...
            level2.Append(startNumberingValue1);
            ...
            level3.Append(startNumberingValue2);
            ...
            level4.Append(startNumberingValue3);
            ...
            level5.Append(startNumberingValue4);
            ...
            level6.Append(startNumberingValue5);
            ...
            level7.Append(startNumberingValue6);
            ...
            level8.Append(startNumberingValue7);
            ...
            level9.Append(startNumberingValue8);
            ...
            level10.Append(startNumberingValue9);
            ...
            level11.Append(startNumberingValue10);
            ...
            Nsid nsid3 = new Nsid() { Val = "34F3181C" };
            MultiLevelType multiLevelType3 = new MultiLevelType() { Val = MultiLevelValues.HybridMultilevel };
            TemplateCode templateCode3 = new TemplateCode() { Val = "2CAACE3C" };

            Level level19 = new Level() { LevelIndex = 0, TemplateCode = "2340CDE0" };
            ...
            RunFonts runFonts20 = new RunFonts() { Hint = FontTypeHintValues.Default, Ascii = "Calibri", HighAnsi = "Calibri", ComplexScript = "Calibri", EastAsiaTheme = ThemeFontValues.MinorEastAsia };

            numberingSymbolRunProperties19.Append(runFonts20);
            ...
            Level level20 = new Level() { LevelIndex = 1, TemplateCode = "2340CDE0" };
            ...
            RunFonts runFonts21 = new RunFonts() { Hint = FontTypeHintValues.Default, Ascii = "Calibri", HighAnsi = "Calibri", ComplexScript = "Calibri", EastAsiaTheme = ThemeFontValues.MinorEastAsia };

            numberingSymbolRunProperties20.Append(runFonts21);
            ...
            Indentation indentation22 = new Indentation() { Start = "2160", Hanging = "360" };
            ...
            numberingSymbolRunProperties21.Append(runFonts22);

            level21.Append(startNumberingValue18);
            ...
            RunFonts runFonts23 = new RunFonts() { Hint = FontTypeHintValues.Default, Ascii = "Symbol", HighAnsi = "Symbol" };

            numberingSymbolRunProperties22.Append(runFonts23);

            level22.Append(startNumberingValue19);
            ...
            RunFonts runFonts24 = new RunFonts() { Hint = FontTypeHintValues.Default, Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };

            numberingSymbolRunProperties23.Append(runFonts24);

            level23.Append(startNumberingValue20);
            ...
            Indentation indentation25 = new Indentation() { Start = "4320", Hanging = "360" };
            ...
            numberingSymbolRunProperties24.Append(runFonts25);

            level24.Append(startNumberingValue21);
            ...
            RunFonts runFonts26 = new RunFonts() { Hint = FontTypeHintValues.Default, Ascii = "Symbol", HighAnsi = "Symbol" };

            numberingSymbolRunProperties25.Append(runFonts26);

            level25.Append(startNumberingValue22);
            ...
            RunFonts runFonts27 = new RunFonts() { Hint = FontTypeHintValues.Default, Ascii = "Courier New", HighAnsi = "Courier New", ComplexScript = "Courier New" };

            numberingSymbolRunProperties26.Append(runFonts27);

            level26.Append(startNumberingValue23);
            ...
            Indentation indentation28 = new Indentation() { Start = "6480", Hanging = "360" };
            ...
            RunFonts runFonts28 = new RunFonts() { Hint = FontTypeHintValues.Default, Ascii = "Wingdings", HighAnsi = "Wingdings" };

            numberingSymbolRunProperties27.Append(runFonts28);

            level27.Append(startNumberingValue24);
        ...
        private void GenerateFontTablePart1Content(FontTablePart fontTablePart1)
        {
            ...
            Font font7 = new Font() { Name = "Cordia New" };
            Panose1Number panose1Number7 = new Panose1Number() { Val = "020B0304020202020204" };
            ...
            Font font8 = new Font() { Name = "Yu Gothic Light" };
            AltName altName2 = new AltName() { Val = "游ゴシック Light" };
            Panose1Number panose1Number8 = new Panose1Number() { Val = "020B0300000000000000" };
            ...
            FontSignature fontSignature8 = new FontSignature() { UnicodeSignature0 = "E00002FF", UnicodeSignature1 = "2AC7FDFF", UnicodeSignature2 = "00000016", UnicodeSignature3 = "00000000", CodePageSignature0 = "0002009F", CodePageSignature1 = "00000000" };

            font8.Append(altName2);
            ...
            Font font9 = new Font() { Name = "Calibri Light" };
            Panose1Number panose1Number9 = new Panose1Number() { Val = "020F0302020204030204" };
            ...
            FontSignature fontSignature9 = new FontSignature() { UnicodeSignature0 = "E4002EFF", UnicodeSignature1 = "C000247B", UnicodeSignature2 = "00000009", UnicodeSignature3 = "00000000", CodePageSignature0 = "000001FF", CodePageSignature1 = "00000000" };
            ...
            Font font10 = new Font() { Name = "Angsana New" };
            Panose1Number panose1Number10 = new Panose1Number() { Val = "02020603050405020304" };
            ...
            FontSignature fontSignature10 = new FontSignature() { UnicodeSignature0 = "81000003", UnicodeSignature1 = "00000000", UnicodeSignature2 = "00000000", UnicodeSignature3 = "00000000", CodePageSignature0 = "00010001", CodePageSignature1 = "00000000" };
