...
namespace Generate_Word_Report
{
    public class Class1
    {
        ...
        #region mine
        private void FN_BarChart(ChartPart chartPart2, Dictionary<string, int> data, string chartTitle, int chartTitleSize = 12, int axisLabelSize = 10)
        {
            ...
            chartSpace1.Append(externalData);
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            C.ChartReference chartReference = new C.ChartReference() { Id = "rId99" };
            ...
            graphicData1.Append(chartReference);
            ...
            //--
            Paragraph paragraph200 = new Paragraph() { RsidParagraphAddition = "00F216F1", RsidRunAdditionDefault = "00F216F1" };
            
            Run run200 = new Run();

            RunProperties runProperties200 = new RunProperties();
            NoProof noProof200 = new NoProof();

            runProperties200.Append(noProof200);

            Drawing drawing200 = new Drawing();

            Wp.Inline inline200 = new Wp.Inline() { DistanceFromTop = (UInt32Value)0U, DistanceFromBottom = (UInt32Value)0U, DistanceFromLeft = (UInt32Value)0U, DistanceFromRight = (UInt32Value)0U };
            Wp.Extent extent200 = new Wp.Extent() { Cx = 5486400L, Cy = 3200400L };
            Wp.EffectExtent effectExtent200 = new Wp.EffectExtent() { LeftEdge = 0L, TopEdge = 0L, RightEdge = 19050L, BottomEdge = 19050L };
            Wp.DocProperties docProperties200 = new Wp.DocProperties() { Id = (UInt32Value)2U, Name = "Chart 3" };
            Wp.NonVisualGraphicFrameDrawingProperties nonVisualGraphicFrameDrawingProperties200 = new Wp.NonVisualGraphicFrameDrawingProperties();

            A.Graphic graphic200 = new A.Graphic();
            graphic200.AddNamespaceDeclaration("a", "http://schemas.openxmlformats.org/drawingml/2006/main");

            A.GraphicData graphicData200 = new A.GraphicData() { Uri = "http://schemas.openxmlformats.org/drawingml/2006/chart" };

            C.ChartReference chartReference200 = new C.ChartReference() { Id = "rId20" };
            chartReference200.AddNamespaceDeclaration("c", "http://schemas.openxmlformats.org/drawingml/2006/chart");
            chartReference200.AddNamespaceDeclaration("r", "http://schemas.openxmlformats.org/officeDocument/2006/relationships");

            graphicData200.Append(chartReference200);

            graphic200.Append(graphicData200);

            inline200.Append(extent200);
            inline200.Append(effectExtent200);
            inline200.Append(docProperties200);
            inline200.Append(nonVisualGraphicFrameDrawingProperties200);
            inline200.Append(graphic200);

            drawing200.Append(inline200);

            run200.Append(runProperties200);
            run200.Append(drawing200);

            paragraph200.Append(run200);
            //--
