...
namespace Generate_Word_Report.NewGen
{
    public class word_emtry
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Body body1 = new Body();
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "00E16ED3", RsidParagraphAddition = "00F56D5B", RsidParagraphProperties = "00E16ED3", RsidRunAdditionDefault = "00F56D5B", ParagraphId = "09CFE4A1", TextId = "54DB5FCD" };

            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00E16ED3", RsidR = "00F56D5B", RsidSect = "00E16ED3" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            Rsid rsid6 = new Rsid() { Val = "00E16ED3" };
