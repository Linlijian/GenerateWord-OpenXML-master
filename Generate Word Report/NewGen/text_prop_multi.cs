...
namespace Generate_Word_Report.NewGen
{
    public class text_prop_multi
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "00702081", RsidParagraphProperties = "00F56D5B", RsidRunAdditionDefault = "000A0595", ParagraphId = "066DAA1B", TextId = "2D62FFE2" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphMarkRevision = "000A0595", RsidParagraphAddition = "000A0595", RsidParagraphProperties = "000A0595", RsidRunAdditionDefault = "000A0595", ParagraphId = "2ECEECAA", TextId = "05FA686E" };
            ...
            paragraphMarkRunProperties2.Append(italicComplexScript3);
            ...
            Run run2 = new Run() { RsidRunProperties = "000A0595" };
            ...
            runProperties2.Append(italic4);
            runProperties2.Append(italicComplexScript4);
            runProperties2.Append(underline2);
            Text text2 = new Text();
            text2.Text = "Txt_prop_i";

            run2.Append(runProperties2);
            run2.Append(text2);

            Run run3 = new Run() { RsidRunProperties = "000A0595" };
            ...
            runProperties3.Append(italic5);
            runProperties3.Append(italicComplexScript5);
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphMarkRevision = "00702081", RsidParagraphAddition = "000A0595", RsidParagraphProperties = "00F56D5B", RsidRunAdditionDefault = "000A0595", ParagraphId = "49FF3F5E", TextId = "77777777" };

            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00702081", RsidR = "000A0595" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            Rsid rsid3 = new Rsid() { Val = "003E1962" };
            Rsid rsid4 = new Rsid() { Val = "003F2413" };
            Rsid rsid5 = new Rsid() { Val = "00671749" };
            Rsid rsid6 = new Rsid() { Val = "00702081" };
            Rsid rsid7 = new Rsid() { Val = "00745E8C" };
            Rsid rsid8 = new Rsid() { Val = "009C4315" };
            Rsid rsid9 = new Rsid() { Val = "00AD54DD" };
            Rsid rsid10 = new Rsid() { Val = "00B55F5A" };
