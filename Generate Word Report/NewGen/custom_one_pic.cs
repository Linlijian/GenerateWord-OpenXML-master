...
namespace Generate_Word_Report.NewGen
{
    public class custom_one_pic
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph7 = newLineImage("00000001", "00000002", "rId7");
        ...
        private Drawing addPicNoFormat(string rId)
        {
            Drawing drawing1 = new Drawing();
            ...
            Wp.Extent extent1 = new Wp.Extent() { Cx = 1984075L, Cy = 2647485L };
            ...
            A.Transform2D transform2D1 = new A.Transform2D();
            A.Offset offset1 = new A.Offset() { X = 0L, Y = 0L };
            A.Extents extents1 = new A.Extents() { Cx = 2007151L, Cy = 2678277L };
        ...
        private Paragraph newLineImage(string paragraphId, string textId, string rId)
        {
            ...
            Drawing drawing = addPicNoFormat(rId);
