...
namespace Generate_Word_Report.NewGen
{
    public class custom_one_pic
    {
        ...
        private void CreateParts(WordprocessingDocument document)
        {
            ...
            NumberingDefinitionsPart numberingDefinitionsPart1 = mainDocumentPart1.AddNewPart<NumberingDefinitionsPart>("rId12");
            GenerateNumberingDefinitions(numberingDefinitionsPart1);
        }
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph ListParagraph1 = newLineListParagraph("1", 0);
            Paragraph ListParagraph2 = newLineListParagraph("2", 0);
            Paragraph ListParagraph3 = newLineListParagraph("21", 1);
            Paragraph ListParagraph4 = newLineListParagraph("211", 2);
            Paragraph ListParagraph5 = newLineListParagraph("2111", 3);
            Paragraph ListParagraph6 = newLineListParagraph("3", 0);
            ...
            body1.Append(ListParagraph1);
            body1.Append(ListParagraph2);
            body1.Append(ListParagraph3);
            body1.Append(ListParagraph4);
            body1.Append(ListParagraph5);
            body1.Append(ListParagraph6);
        ...
        private void GenerateNumberingDefinitionsABC(NumberingDefinitionsPart numberingDefinitionsPart1)
        {
            ...
            Indentation indentation2 = new Indentation() { Start = "360", Hanging = "360" };
        ...
        private void GenerateNumberingDefinitionsNumber(NumberingDefinitionsPart numberingDefinitionsPart1)
        {
            Numbering numbering1 = new Numbering() { MCAttributes = new MarkupCompatibilityAttributes() { Ignorable = "w14 w15 w16se w16cid w16 w16cex w16sdtdh wp14" } };
            numbering1.AddNamespaceDeclaration("wpc", "http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas");
            numbering1.AddNamespaceDeclaration("cx", "http://schemas.microsoft.com/office/drawing/2014/chartex");
        ...
        private void GenerateNumberingDefinitions(NumberingDefinitionsPart numberingDefinitionsPart1)
        {
            Numbering numbering1 = new Numbering() { MCAttributes = new MarkupCompatibilityAttributes() { Ignorable = "w14 w15 w16se w16cid w16 w16cex w16sdtdh wp14" } };
            numbering1.AddNamespaceDeclaration("wpc", "http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas");
            numbering1.AddNamespaceDeclaration("cx", "http://schemas.microsoft.com/office/drawing/2014/chartex");
            ...
            AbstractNum abstractNum1 = new AbstractNum() { AbstractNumberId = 0 };
            abstractNum1.SetAttribute(new OpenXmlAttribute("w15", "restartNumberingAfterBreak", "http://schemas.microsoft.com/office/word/2012/wordml", "0"));
            Nsid nsid1 = new Nsid() { Val = "0D790BE2" };
            MultiLevelType multiLevelType1 = new MultiLevelType() { Val = MultiLevelValues.HybridMultilevel };
            TemplateCode templateCode1 = new TemplateCode() { Val = "A334A960" };

            Level level1 = new Level() { LevelIndex = 0, TemplateCode = "0409000D" };
            StartNumberingValue startNumberingValue1 = new StartNumberingValue() { Val = 1 };
            NumberingFormat numberingFormat1 = new NumberingFormat() { Val = NumberFormatValues.Bullet };
            LevelText levelText1 = new LevelText() { Val = "ü" };
            LevelJustification levelJustification1 = new LevelJustification() { Val = LevelJustificationValues.Left };

            PreviousParagraphProperties previousParagraphProperties1 = new PreviousParagraphProperties();
            Indentation indentation2 = new Indentation() { Start = "720", Hanging = "360" }; //ไอเชี่ยนี้อาจจะแก้ในภายหลังไม่งั้นจะกว้างมาก
            ...
            Nsid nsid2 = new Nsid() { Val = "159C2ACB" };
            ...
            Indentation indentation11 = new Indentation() { Start = "360", Hanging = "360" };
            ...
            Indentation indentation12 = new Indentation() { Start = "720", Hanging = "360" };
            ...
            Indentation indentation13 = new Indentation() { Start = "1080", Hanging = "360" };
            ...
            Indentation indentation15 = new Indentation() { Start = "1800", Hanging = "360" };
            ...
            Indentation indentation16 = new Indentation() { Start = "2160", Hanging = "360" };
            ...
            Indentation indentation17 = new Indentation() { Start = "2520", Hanging = "360" };
            ...
            Indentation indentation19 = new Indentation() { Start = "3240", Hanging = "360" };
        ...
        private Drawing addPicFormat(string rId, string base64image, string format = null, int horizontalPosition = 0, int verticalPosition = 0, int sizeX = 0, int sizeY = 0)
        {
            if(format == null)
            {
                return addPicNoFormat(rId, base64image, sizeX, sizeY);
            }

            Drawing drawing1 = new Drawing();

            var size = Getsize(base64image, sizeX, sizeY);
            ...
            positionOffset1.Text = Getspacebar(horizontalPosition);
            ...
            positionOffset2.Text = Getenter(verticalPosition);
            ...
            if (format == Help.wrapThrough)
            {
                wrapThrough1.Append(wrapPolygon1);
            }
            else if (format == Help.wrapTight)
            {
            ...
            else if (format == Help.wrapTopBottom)
                anchor1.Append(wrapTopBottom1);
            else if (format == Help.wrapSquare)
                anchor1.Append(wrapSquare1);
            else if (format == Help.wrapNone)
        ...
        private Drawing addPicNoFormat(string rId, string base64image, int sizeX = 0, int sizeY = 0)
        {
            Drawing drawing1 = new Drawing();
        ...
        private Paragraph newLine(string paragraphId, string textId)
        {
            Paragraph paragraph = new Paragraph() { RsidParagraphAddition = "00F56D5B", RsidParagraphProperties = "00F56D5B", RsidRunAdditionDefault = "00F56D5B", ParagraphId = paragraphId, TextId = textId };
            return paragraph;
        }
        private Paragraph newLine(string paragraphId, string textId, string srtText)
        {
            Paragraph paragraph = new Paragraph() { RsidParagraphAddition = "00F56D5B", RsidParagraphProperties = "00F56D5B", RsidRunAdditionDefault = "00F56D5B", ParagraphId = paragraphId, TextId = textId };
            Run run = new Run();
            Text text = new Text();
        ...
        private Paragraph newLine(string paragraphId, string textId, string srtText, string text_prop)
        {
            ...
            Run run1 = new Run() { RsidRunProperties = "00B55F5A" };
        ...
        private Paragraph newLine(string paragraphId, string textId, System.Collections.Generic.List<string[]> text_prop)
        {
            ...
            //มี 2 แบบคือสร้าง run ไว้ก่อนแล้วเพิ่ม runProperties ลงไป
            ...
            foreach (var txt in text_prop)
            {
                ...
                else if (txt[1] == Help.paragraphItalic)
                {
                ...
                else if (txt[1] == Help.paragraphUnderline)
                {
        ...
        private Paragraph newLineImage(string paragraphId, string textId, string rId, string base64image)
        {
            ...
            Drawing drawing = addPicNoFormat(rId, base64image);
        ...
        private Paragraph newLineImage(string paragraphId, string textId, string rId, string base64image, string horizontalAlignment, int sizeX = 0, int sizeY = 0)
        {
            ...
            Drawing drawing = addPicFormat(rId, base64image, null, 0, 0, sizeX, sizeY);
        ...
        private Paragraph newLineImage(string paragraphId, string textId, string rId, string base64image, string format, int horizontalPosition, int verticalPosition, int sizeX = 0, int sizeY = 0)
        {
            Paragraph paragraph = newLine(paragraphId, textId);
            ...
            Drawing drawing = addPicFormat(rId, base64image, format, horizontalPosition, verticalPosition, sizeX, sizeY);
        ...
        private Paragraph newLineListParagraph(string Text, int NumberingLevelReference)
        {
            Paragraph paragraph = new Paragraph() { RsidParagraphAddition = "00534E3C", RsidParagraphProperties = "00534E3C", RsidRunAdditionDefault = "00534E3C", ParagraphId = "4C8F1FC8", TextId = "01B0C16F" };

            ParagraphProperties paragraphProperties1 = new ParagraphProperties();
            ParagraphStyleId paragraphStyleId1 = new ParagraphStyleId() { Val = "ListParagraph" };

            NumberingProperties numberingProperties1 = new NumberingProperties();
            NumberingLevelReference numberingLevelReference1 = new NumberingLevelReference() { Val = NumberingLevelReference };
            NumberingId numberingId1 = new NumberingId() { Val = Help.numberingIdBullet }; // 1 numbering | 2 bullet
        ...
        public void aaa()
        {
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00534E3C", RsidParagraphProperties = "00534E3C", RsidRunAdditionDefault = "00534E3C", ParagraphId = "4C8F1FC8", TextId = "01B0C16F" };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "00534E3C", RsidParagraphProperties = "00534E3C", RsidRunAdditionDefault = "00534E3C", ParagraphId = "74F981A2", TextId = "51AC1CA5" };
            ...
            Paragraph paragraph4 = new Paragraph() { RsidParagraphAddition = "00534E3C", RsidParagraphProperties = "00534E3C", RsidRunAdditionDefault = "00534E3C", ParagraphId = "52D3D9A1", TextId = "6D6351B8" };
        ...
        private string imagePart2Data = "";

        private System.Collections.Generic.List<long> Getsize(string base64image, int sizeX, int sizeY)
        {
            ...
            return new System.Collections.Generic.List<long> { widthEmus, heightEmus };
        }
