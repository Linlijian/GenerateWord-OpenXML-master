...
namespace Generate_Word_Report
{
    class Empty
    {
        ...
        /// <summary>
        /// ทั้งหมดนี้คือสิ่งที่จำเป็นในการสร้าง word ไม่ควรลบ
        /// อยากได้อะไรก็ใส่เรียงต่อๆ กันไป
        /// rId1-7 มันเรียงกันได้เว้ย หลังจาก rId7 (ในที่นี้) ให้ใส่ตามใจได้เลยเชี่ยไรก็ได้แต่ต้องตรงกับที่อ้างอิ้งไว้ตอนกำหนดค่า GenerateMainDocumentPart1Content
        /// </summary>
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00454A2A" };
            Rsid rsid1 = new Rsid() { Val = "00454A2A" };
            Rsid rsid2 = new Rsid() { Val = "004F7B39" };
            Rsid rsid3 = new Rsid() { Val = "00520412" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "16BD13A0" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{A8865FA4-F13C-4C24-9349-1A01F6475FA4}" };
