...
namespace Generate_Word_Report.NewGen
{
    public class custom_one_pic
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Wp.Anchor anchor1 = addPicFormat(Help.horizontalAlignmentLeft, 2000000, 3400000); //center left right
        ...
        private Wp.Anchor addPicFormat(string horizontalAlignment, int sizeX, int sizeY)
        {
