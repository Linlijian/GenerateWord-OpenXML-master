...
namespace Generate_Word_Report.NewGen
{
    public class NumberingFont
    {
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            charactersWithSpaces1.Text = "313";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "00444611", RsidRunAdditionDefault = "00C23069", ParagraphId = "4F613A25", TextId = "77777777" };
            ...
            Text text1 = new Text();
            text1.Text = "สรุปรายงานวิเคราะห์";
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphAddition = "00444611", RsidRunAdditionDefault = "00C23069", ParagraphId = "6000830B", TextId = "77777777" };
            ...
            runProperties5.Append(boldComplexScript7);
            runProperties5.Append(fontSize7);
            Text text5 = new Text();
            text5.Text = "จะประกอบด้วยรายละเอียดจำนวน";
            ...
            runProperties7.Append(boldComplexScript9);
            ...
            runProperties9.Append(boldComplexScript11);
            runProperties9.Append(fontSize11);
            Text text9 = new Text();
            text9.Text = "ดังต่อไปนี้";
            ...
            paragraph2.Append(proofError5);
            paragraph2.Append(run5);
            paragraph2.Append(proofError6);
            paragraph2.Append(run6);
            paragraph2.Append(proofError7);
            paragraph2.Append(run7);
            paragraph2.Append(proofError8);
            paragraph2.Append(run8);
            paragraph2.Append(proofError9);
            paragraph2.Append(run9);
            paragraph2.Append(proofError10);

            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "00444611", RsidRunAdditionDefault = "00C23069", ParagraphId = "0EB02287", TextId = "77777777" };
            ...
            text11.Text = "สรุปผลการวิเคราะห์ในภาพรวม";
            ...
            paragraph3.Append(proofError11);
            paragraph3.Append(run11);
            paragraph3.Append(proofError12);

            Paragraph paragraph4 = new Paragraph() { RsidParagraphAddition = "00444611", RsidRunAdditionDefault = "00C23069", ParagraphId = "16294D3E", TextId = "77777777" };
            ...
            text17.Text = " (Weaknesses)";

            run17.Append(runProperties17);
            run17.Append(text17);

            paragraph4.Append(paragraphProperties4);
            paragraph4.Append(proofError13);
            paragraph4.Append(run12);
            paragraph4.Append(proofError14);
            paragraph4.Append(run13);
            paragraph4.Append(proofError15);
            paragraph4.Append(run14);
            paragraph4.Append(proofError16);
            paragraph4.Append(run15);
            paragraph4.Append(proofError17);
            paragraph4.Append(run16);
            paragraph4.Append(proofError18);
            paragraph4.Append(run17);

            Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "00444611", RsidRunAdditionDefault = "00C23069", ParagraphId = "4984FFD7", TextId = "77777777" };
            ...
            paragraphMarkRunProperties5.Append(fontSize22);

            paragraphProperties5.Append(numberingProperties3);
            ...
            runProperties20.Append(fontSize25);
            ...
            text26.Text = "และประเด็นที่ต้องติดตามจากครั้งก่อน";
            ...
            runProperties28.Append(runFonts33);
            ...
            paragraph5.Append(proofError19);
            paragraph5.Append(run18);
            paragraph5.Append(proofError20);
            paragraph5.Append(run19);
            paragraph5.Append(proofError21);
            paragraph5.Append(run20);
            paragraph5.Append(proofError22);
            paragraph5.Append(run21);
            paragraph5.Append(proofError23);
            paragraph5.Append(run22);
            paragraph5.Append(proofError24);
            paragraph5.Append(run23);
            paragraph5.Append(proofError25);
            paragraph5.Append(run24);
            paragraph5.Append(proofError26);
            paragraph5.Append(run25);
            paragraph5.Append(proofError27);
            paragraph5.Append(run26);
            paragraph5.Append(proofError28);
            paragraph5.Append(run27);
            paragraph5.Append(proofError29);
            paragraph5.Append(run28);
            paragraph5.Append(proofError30);

            Paragraph paragraph6 = new Paragraph() { RsidParagraphAddition = "00C23069", RsidParagraphProperties = "00916EBE", RsidRunAdditionDefault = "00C23069", ParagraphId = "100ACCEC", TextId = "7CA432BF" };
            ...
            paragraphProperties6.Append(numberingProperties4);
            ...
            runProperties29.Append(runFonts34);
            runProperties29.Append(fontSize34);
            Text text29 = new Text();
            text29.Text = "การประเมินความเสี่ยง";
            ...
            runProperties30.Append(runFonts35);
            runProperties30.Append(fontSize35);
            Text text30 = new Text() { Space = SpaceProcessingModeValues.Preserve };
            text30.Text = " Internal ";

            run30.Append(runProperties30);
            run30.Append(text30);

            paragraph6.Append(paragraphProperties6);
            paragraph6.Append(proofError31);
            paragraph6.Append(run29);
            paragraph6.Append(proofError32);
            paragraph6.Append(run30);

            SectionProperties sectionProperties1 = new SectionProperties() { RsidR = "00C23069" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            Rsid rsid4 = new Rsid() { Val = "00444611" };
            Rsid rsid5 = new Rsid() { Val = "0047664C" };
            Rsid rsid6 = new Rsid() { Val = "00671749" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "6AF6E2BE" };
        ...
        private void GenerateNumberingDefinitionsPart1Content(NumberingDefinitionsPart numberingDefinitionsPart1)
        {
            ...
            numberingSymbolRunProperties2.Append(runFonts38);
            ...
            numberingSymbolRunProperties3.Append(runFonts39);
            ...
            numberingSymbolRunProperties4.Append(runFonts40);
            ...
            numberingSymbolRunProperties5.Append(runFonts41);
            ...
            numberingSymbolRunProperties6.Append(runFonts42);
            ...
            RunFonts runFonts43 = new RunFonts() { Hint = FontTypeHintValues.Default };

            numberingSymbolRunProperties7.Append(runFonts43);
            ...
            RunFonts runFonts44 = new RunFonts() { Hint = FontTypeHintValues.Default };

            numberingSymbolRunProperties8.Append(runFonts44);
            ...
            RunFonts runFonts45 = new RunFonts() { Hint = FontTypeHintValues.Default };

            numberingSymbolRunProperties9.Append(runFonts45);
