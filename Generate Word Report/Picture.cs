...
namespace Generate_Word_Report
{
    public class Picture
    {
        ...
        private void CreateParts(WordprocessingDocument document)
        {
            ...
            WebSettingsPart webSettingsPart1 = mainDocumentPart1.AddNewPart<WebSettingsPart>("rId1");
            ...
            ThemePart themePart1 = mainDocumentPart1.AddNewPart<ThemePart>("rId4");
            GenerateThemePart1Content(themePart1);

            FontTablePart fontTablePart1 = mainDocumentPart1.AddNewPart<FontTablePart>("rId5");
            GenerateFontTablePart1Content(fontTablePart1);

            ImagePart imagePart1 = mainDocumentPart1.AddNewPart<ImagePart>("image/jpeg", "rId14");
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "004670D4", RsidParagraphProperties = "009636EF", RsidRunAdditionDefault = "009636EF", ParagraphId = "5452AA23", TextId = "3F692C11" };
            ...
            ComplexScript complexScript1 = new ComplexScript();

            runProperties1.Append(noProof1);
            runProperties1.Append(complexScript1);

            Drawing drawing1 = new Drawing();

            Wp.Inline inline1 = new Wp.Inline() { DistanceFromTop = (UInt32Value)0U, DistanceFromBottom = (UInt32Value)0U, DistanceFromLeft = (UInt32Value)0U, DistanceFromRight = (UInt32Value)0U, AnchorId = "3BFD887F", EditId = "271A84E6" };
            Wp.Extent extent1 = new Wp.Extent() { Cx = 5934710L, Cy = 7919085L };
            Wp.EffectExtent effectExtent1 = new Wp.EffectExtent() { LeftEdge = 0L, TopEdge = 0L, RightEdge = 8890L, BottomEdge = 5715L };
            ...
            A.Blip blip1 = new A.Blip() { Embed = "rId14" };
            ...
            A.Offset offset1 = new A.Offset() { X = 0L, Y = 1000L };
            A.Extents extents1 = new A.Extents() { Cx =1080L, Cy = 720L };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidR = "004670D4" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00553600" };
            Rsid rsid1 = new Rsid() { Val = "004670D4" };
            Rsid rsid2 = new Rsid() { Val = "00553600" };
            Rsid rsid3 = new Rsid() { Val = "009636EF" };
            Rsid rsid4 = new Rsid() { Val = "009E771B" };
            Rsid rsid5 = new Rsid() { Val = "00C035C0" };
            Rsid rsid6 = new Rsid() { Val = "00F30FE0" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "2A6A22AC" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{A59BB7E6-7177-490F-AB42-1C0E07A9C131}" };
